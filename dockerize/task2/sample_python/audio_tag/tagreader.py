...
print('This track is by {}.'.format(TRACK))
print('It is {} seconds long.'.format(DURATION))
print('It is from album {}.'.format(ALBUM))
print('The genre of the song is {}.'.format(GENRE))
print('The title of the song is {}.'.format(TITLE))
